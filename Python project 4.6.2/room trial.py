...
# Customer Contact
        lbl_cust_contact=Label(labelframeleft,text="Custoemr Contact",font=("arial",12,"bold"),padx=2,pady=6)
...
#==========================Update Button=============================
        btnUpdate=Button(btn_frame,text="Update",command=self.update,font=("arial",12,"bold"),bg="black",fg="gold",width=9,cursor="hand1")
...
#===========================================Table Frame##########################################################
        ...
        combo_Serach=ttk.Combobox(Table_Frame,font=("arial",12,"bold"),width=27,state="readonly")
        ...
        btnSearch=Button(Table_Frame,text="Search",font=("arial",12,"bold"),bg="black",fg="gold",width=7)
...
#=====================================Rightside Image===================================================
        ...
        self.room_details=ttk.Treeview(details_table,column=("contact","checkin","checkout","roomtype","roomavailable","meal","noOfdays"),
        ...
        self.room_details.column("checkin",width=100)
        self.room_details.column("checkout",width=100)
